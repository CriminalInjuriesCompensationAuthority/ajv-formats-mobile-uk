...
describe('validator', () => {
    describe('UK mobile phone number', () => {
        ...
        it('should validate valid UK mobile numbers', () => {
            ...
            const result10 = validator.isValidMobilePhoneNumber(
                '\u200B\t\t+44 (0)7123 \uFEFF 456 789 \r\n'
            );
            ...
            // expect(result10).toBe(true); is this applicable to us??
        });
        ...
        it('should NOT validate invalid UK mobile numbers', () => {
            ...
            const result23 = validator.isValidMobilePhoneNumber('a7123456789');
            const result24 = validator.isValidMobilePhoneNumber(')7123456789');
            ...
            expect(result23).toBe(false);
            expect(result24).toBe(false);
        });
